...
import { LinkCodec, linkCodecFactory, BlockCodec, blockCodecFactory, multiBlockCodecFactory } from "../codecs"
...
describe('Indexing', function () {
    ...
    test("create index", async () => {
        ...
        const index: Index = await tx.uniqueIndex(v1, KeyTypes.NAME, IndexTypes.L2_NAME)
